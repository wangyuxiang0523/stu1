...
import com.fh.anothException.FileUploadException;
...
public class OSSClientUtil {
     ...
     * accessKey
     */
    private String accessKeyId = "LTAI4FgtQ7Wnd51SmHu9n5QV";
    /**
     * accessKeySecret
     */
    private String accessKeySecret = "sIyQmejr3iiToXtXF5xUJBw1ZN3tCs";
    /**
     * 空间
     */
    private String bucketName = "wangyuxiang1";
    /**
     * 文件存储目录
     */
    private String filedir = "xuxiaobing/";
    ...
    public String uploadImg2Oss(MultipartFile file, Long id) {
        ...
        if (file.getSize() > MAX_SIZE) {
            throw new FileUploadException(StatusCodes.IMG_MAX_SIZE);
        }
        //获取文件名
        ...
        if (!substring.equals(".jpg") && !substring.equals(".jpeg") && !substring.equals(".png")) {
            throw new FileUploadException(StatusCodes.IMG_UPLOAD_ERROR);
        }
        //设置文件名
